...
# =============================================================================
#
# Automated bootstrap for deploying coJournalist on Supabase plus either
...
deploy_render() {
    ...
    # Get the Render URL
    prompt_required RENDER_URL "Optional FastAPI URL (e.g., https://cojournalist-api-optional.onrender.com)"
